...
const ToolCard = ({ title, description, icon: Icon, to, color = "bg-white" }) => {
    return (
        <Link
            to={to}
            className={`group relative p-4 md:p-6 rounded-2xl shadow-sm border border-gray-100 md:hover:shadow-xl transition-all duration-300 ${color} flex flex-col justify-between overflow-hidden`}
        >
